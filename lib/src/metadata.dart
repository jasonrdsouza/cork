...
class MetadataOutput {
  ...
  void addReadingTime() {
    metadata['${autogeneratedMetadataPrefix}reading_time'] = calculateReadingTimeMinutes(content);
  }

  void addLixScore() {
    metadata['${autogeneratedMetadataPrefix}lix_readability_score'] = Lix.fromString(content).readability;
  }
